As a senior developer working on this Computer Vision project I'm looking for some out of the box ideas to make this project amazing. Best visualization techniques, Gen AI techniques and approaches.
Currently I'm thinking about following approach
1. EDA and visualizations like pre post comparison
2. Pre Processing and clean up
3. Select 3 types CV models 
4. Train 3 models and show comparative results
5. Find Best model
6. Test the Best model
7. Apply Gen AI techniques on images to Image Denoising, Image Super-Resolution, Image Colorization, Image Inpainting
8. Run the model again and check for accuracy

Prepare the full plan for the same
